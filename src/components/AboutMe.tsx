				...
				<div className="about-me-columns">
					<div>
						...
						<p className="get-to-know-me-description">
							Hi, I'm Owen, a full stack developer with expertise in Golang, Typescript, and React. I have a strong skill set in
							building web applications and am always looking to improve my skills and stay up-to-date with the latest technologies. I
							am an eager learner and enjoy collaborating with others.
						</p>
					</div>
